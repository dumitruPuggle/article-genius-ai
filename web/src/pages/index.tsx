    ...
    <>
      ...
      <main className={`${styles.main} pt-4`}>
        ...
        <div className={`${styles.pageBody} container-sm`}>
          ...
          <p></p>
          <small>
            But that is not all. Article Genius AI can also help you tailor your
          ...
          <p></p>
          <small>
            And if you are worried about the quality of the content generated by
            AI, do not be. Article Genius AI uses the latest in machine learning
